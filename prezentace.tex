...
\projectinfo{
  ...
  title={Protokol pro bezpečné sdílení \\ (perzistentních) dat \\ v peer-to-peer systémech}, % Název prezentace / Presentation title (The whole title of the presented work suitably divided into lines that are optically balanced)
  title.footer={Protokol pro bezpečné sdílení dat v peer-to-peer systémech}, % Název prezentace - text zobrazovaný vedle čísla slajdu / Presentation title - displayed next to the slide number (The full title of the presented work, it may be suitably abbreviated to fit the footer)
  author.name={Prokop},  % Jméno autora / Author name
  author.surname={Schield}, % Příjmení autora / Author surname
  ...
  supervisor.surname={Hynek}, % Příjmení vedoucího / Supervisor surname
